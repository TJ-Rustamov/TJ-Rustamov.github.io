...
function ResponsiveImage({ item, loading = "lazy", sizes = "100vw" }) {
  return <img src={asset(item.src)} srcSet={assetSet(item.srcSet)} sizes={item.srcSet ? sizes : undefined} alt={item.alt} loading={loading} draggable="false" />;
}
